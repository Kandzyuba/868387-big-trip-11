...
const tripEventsContainer = document.querySelector(`.trip-controls`);
const POINT_COUNT = 3;
...
render(tripMainContainer, createInfoAndCostTemplate(), `beforeend`);
...
for (let i = 0; i < POINT_COUNT; i++) {
  render(tripEventsContainer, createRoutePointTemplate(), `beforeend`);
}
